 ...
 * @author Usuario
 */
public class tallerr2 extends javax.swing.JFrame {

    /**
     * Creates new form tallerr2
     */
    public tallerr2() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tallerr2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
